...
#### Проблема: "Мало совпадений в результатах"
**Причины и решения**:
1. **Слишком узкий поиск**: Расширьте поисковые запросы
2. **Нерелевантные резюме**: Проверьте соответствие навыков в резюме
3. **Устаревшие вакансии**: Загрузите свежие данные с HH.ru
4. **Неточная модель**: Дообучите модель на большем корпусе данных
